...
<section class="container posts_tabel">
    <h1>Add New Post</h1>
    <form action="/dashboard/posts" method="POST" class="contact_form grid" id="create-form-post">
        @csrf
        <div class="contact_inputs grid">
            <div class="contact_content">
                ...
                <input type="text" id="title" class="contact_input" placeholder="What's the title?" name="title">
            </div>
            <div class="contact_content">
                ...
                <input type="text" id="slug" class="contact_input" placeholder="The slug is automatically filled based on the title" name="slug">
            </div>
        </div>
        <div class="contact_content">
